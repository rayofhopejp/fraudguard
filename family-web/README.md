...
requirements.md 16.3章[v3]の方針により、家族向けSlack通知には相手番号・SMS本文(長さ制限あり)・判定理由を含める。本文を読まないと詐欺かどうか判断できず、詳細を見にアプリを開く一手間が緊急時の対応を遅らせるため。全文の確認や操作(確認済み・切断・ホワイトリスト追加)はこのアプリ内(認証必須)で行う。
